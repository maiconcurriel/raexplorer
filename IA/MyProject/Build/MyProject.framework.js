...
var ASM_CONSTS = {
  7091216: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 7091277: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 7091341: function() {return Module.webglContextAttributes.powerPreference;},  
 7091399: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 7091454: function($0) {performance.now = function() { return $0; };},  
 7091502: function($0) {performance.now = function() { return $0; };},  
 7091550: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _InitWebGLuLipSync(targetObjectNamePtr, targetMethodNamePtr) {
...
var asmLibraryArg = {
  ...
  "InitWebGLuLipSync": _InitWebGLuLipSync,
...
unexportedRuntimeFunction('uLipSync', false);
unexportedRuntimeFunction('uLipSync__user', false);
